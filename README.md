...
> **Objectif** : Déployer un cluster Hadoop en mode pseudo-distribué via Docker, explorer HDFS en ligne de commande et exécuter un premier job MapReduce.
>
> **Environnement** : Docker + `docker-compose` — Hadoop 3.2.1 (image `bde2020`)
>
> **Prérequis** : Docker et Git installés sur la machine
